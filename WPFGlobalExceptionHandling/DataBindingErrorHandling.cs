...
{
    /// <summary>
    /// Utility for adding the ability to throw exceptions when DataBinding errors occur in Windows Presentation Foundation (WPF) applications
    ...
    /// </summary>
    /// <remarks>
    /// This has been very helpful with debugging binding errors due to database connections, etc, because the violating code might not always throw 
    /// an exception - things would just "not bind" with no apparent reason why
    /// </remarks>
