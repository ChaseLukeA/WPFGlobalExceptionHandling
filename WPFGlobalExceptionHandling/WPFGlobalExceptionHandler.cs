...
namespace WPFGlobalExceptionHandling
{
    ...
    /// <para>For Application classes that interface IWPFGlobalExceptionHandler</para>
    /// </summary>
    public static class WPFGlobalExceptionHandler
    {
        ...
        /// </summary>
        /// <remarks>
        /// Any WPF application that implements the IWPFGlobalExceptionHandler interface can call this.UseGlobalExceptionHandling() in the constructor and the app will
        ...
        /// <summary>
        /// Gets the lowest level exception (root exception) from any thrown exception
        /// </summary>
        /// <param name="e"></param>
        /// <returns></returns>
